...
test('Question 1: isRealPalindrome', () => {
  expect(exercises.isRealPalindrome('madam')       
).toEqual(true)
  expect(exercises.isRealPalindrome('Madam')       
).toEqual(true)
  expect(exercises.isRealPalindrome("Madam, I'm Adam")       
).toEqual(true)
  expect(exercises.isRealPalindrome('356653')       
).toEqual(true)
  expect(exercises.isRealPalindrome('356a653')       
).toEqual(true)
  expect(exercises.isRealPalindrome('123ab321')       
).toEqual(false)
});
